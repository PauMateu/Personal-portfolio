...
$(document).ready(function() {
    ...
    $(window).scroll(function() {
        ...
        var percentage1 = (windowBottom - element1Top) / $("#svgContainer").height();
        ...
        var percentage2 = (windowBottom - element2Top) / $("#svgContainer2").height();
        if (percentage2 - 0.3 > 0) {
            var draw = (length * (percentage2 - 0.3));
